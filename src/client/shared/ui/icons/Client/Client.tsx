...
export function Client({ class: className, ...props }: IIcon) {
  return (
    <svg
      ...
      {...props}
    >
      <circle cx="9" cy="9" r="2" stroke="#333" strokeWidth="1" />
      <path
      ...
      />
      <path d="M19 9H14" stroke="#333" strokeWidth="1" stroke-linecap="round" />
      <path
        d="M19 15H16"
        stroke="#333"
        strokeWidth="1"
